...
unsigned long greenTimeout1 = 0;
unsigned long greenTimeout2 = 0;
...
void updateSensors(){
 ...
 if(millis() - greenTimeout1 > 1000){
  clearGreenFlag();
 } 

 if(millis() - greenTimeout2 > 1000){
  clearGreenFlag();
 }
...
/*else
    ...
    for(int speeder = 160; speeder < 220; speeder += 20)
    DaniBoost(speeder,speeder);
    delay(100); 
  }
